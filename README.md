...
> Álvaro Santos-Cuerva, Esther García García-Esquinas, 2026
...
> [!NOTE]
> These steps assume that Git is already installed and configured.

> [!NOTE]
> Data is not included in the repository. It will be available upon request.
...
* Sociodemographic results: Run code/Stata/table1_generator.do
* Multivariate logistic regression for each metal: Run code/Stata/table2_generator.do
* Posterior Inclusion Probabilities for every model: Run code/Stata/pips_table_generator.do
* BKMR: Run code/R/BKMR_flex.R and edit the parameters for outcome, matrix and mixture group for each analysis. Number of knots and iterations are also editable.
